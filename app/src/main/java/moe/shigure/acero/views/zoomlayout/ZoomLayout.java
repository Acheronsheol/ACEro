package moe.shigure.acero.views.zoomlayout;
...
public class ZoomLayout extends LinearLayout {
    ...
    private OnCurrentZoomChangedListener mOnCurrentZoomChangedListener;
    ...
    public void setScale(float scale, int centerX, int centerY) {
        ...
        mCurrentZoom = scale;
        mOnCurrentZoomChangedListener.onChangedZoomValue(mCurrentZoom);
        if(mCurrentZoom>1){
            mOnCurrentZoomChangedListener.OnZooming(true);
        } else {
            mOnCurrentZoomChangedListener.OnZooming(false);
        }
        int sX = getScrollX();
        int sY = getScrollY();
    ...
    * */
    public void resetZoom(){
        if(mCurrentZoom>1) {
            ...
            mScaleHelper.startScale(mCurrentZoom, 1, 0, 0, mAccelerateInterpolator);
        }
    }
    ...
    public void setDoubleClickZoom(float doubleClickZoom) {
        this.mDoubleClickZoom = doubleClickZoom;
    }
    ...
    public void setOnCurrentZoomChangedListener(OnCurrentZoomChangedListener onCurrentZoomChangedListener) {
        mOnCurrentZoomChangedListener = onCurrentZoomChangedListener;
    }

    public interface OnCurrentZoomChangedListener{
        void onChangedZoomValue(float zoomValue);
        void OnZooming(boolean status);
    }
